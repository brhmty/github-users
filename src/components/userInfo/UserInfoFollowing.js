...
function UserInfoFollowing() {
  return (
    <div className="w-[22%] max-sm:w-full h-20 max-sm:mr-2 bg-white flex justify-around items-center">
      <div className="w-10 max-sm:w-8 h-10 ml-4 max-sm:h-8 max-sm:ml-8 max-sm:mr-5 rounded-full flex justify-center items-center bg-indigo-300">
        <BsPersonPlusFill className="w-6 max-sm:w-4 h-6 max-sm:h-4 text-indigo-500" />
      </div>
...
export default UserInfoFollowing;
